...
<script>
    ...
    function setDataRow(item, number) {
        ...
        row.appendChild(usernameCell);
            ...
            //头像
        var yhimgPhotoCell = document.createElement('td');
        var yhimgPhotoImg = document.createElement('img');
        var yhimgPhotoImgValue = item.yhimgPhoto;
        if(yhimgPhotoImgValue !=null && yhimgPhotoImgValue !='' && yhimgPhotoImgValue !='null'){
            yhimgPhotoImg.setAttribute('src', yhimgPhotoImgValue);
            yhimgPhotoImg.setAttribute('height', 100);
            yhimgPhotoImg.setAttribute('width', 100);
            yhimgPhotoCell.appendChild(yhimgPhotoImg);
        }else{
            yhimgPhotoCell.innerHTML = "暂无图片";
        }
        row.appendChild(yhimgPhotoCell);
