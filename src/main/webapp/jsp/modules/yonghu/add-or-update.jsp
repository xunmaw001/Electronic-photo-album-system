                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                   ...
                                   <div class="form-group col-md-6">
                                       ...
                                       <input name="file" type="file" id="yhimgPhotoupload"
                                              class="form-control-file">
                                       <input name="yhimgPhoto" id="yhimgPhoto-input" type="hidden">
                                   </div>
                                   <div class="form-group col-md-6">
                                       <label>性别</label>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="idNumber" name="idNumber" class="form-control"
                                        ...
                                        <input id="role" name="role" value="用户" type="hidden" class="form-control"
                                               placeholder="身份">
...
<script>
    ...
    function upload() {
        ...
        $('#yhimgPhotoupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                var photoUrl= baseUrl + 'file/download?fileName=' + data.result.file;
                document.getElementById('yhimgPhotoImg').setAttribute('src',photoUrl);
                document.getElementById('yhimgPhoto-input').setAttribute('value',photoUrl);
            }
        });
