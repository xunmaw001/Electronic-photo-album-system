            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">相片信息登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="xcname" name="xcname" class="form-control"
                                                   v-model="ruleForm.xcname" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="chuanjianTime" name="chuanjianTime" class="form-control"
                                                   v-model="ruleForm.chuanjianTime" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="xiangcheId" name="xiangcheId" v-model="ruleForm.xiangcheId" readonly type="hidden">

                                    <div class="form-group col-md-6">
                                        <label>相片名称</label>
                                        <input id="xpname" name="xpname" class="form-control"
                                               v-model="ruleForm.xpname" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="paishedidian" name="paishedidian" class="form-control"
                                               v-model="ruleForm.paishedidian" readonly>
                                    </div>

                                <div class="form-group col-md-6">
                                    <label>相片</label>
                                    <img id="xpimgPhotoImg" width="100" height="100">
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>相片拍摄人</label>
                                        <input id="paisheren" name="paisheren" class="form-control"
                                               v-model="ruleForm.paisheren" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="xpsize" name="xpsize" class="form-control"
                                               v-model="ruleForm.xpsize" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>相片分类</label>
                                    <input id="fenleiValue" name="fenleiValue" class="form-control"
                                           v-model="ruleForm.fenleiValue" readonly>
                                </div>
        ...
        if (ruleForm.xiangcheContent != null && ruleForm.xiangcheContent != 'null' && ruleForm.xiangcheContent != '') {
            var xiangcheContentUeditor = UE.getEditor('xiangcheContentEditor');
                xiangcheContentUeditor.ready(function () {
                    ...
                    xiangcheContentUeditor.setDisabled('fullscreen');
            });
        }
        if (ruleForm.xiangpianContent != null && ruleForm.xiangpianContent != 'null' && ruleForm.xiangpianContent != '') {
            var xiangpianContentUeditor = UE.getEditor('xiangpianContentEditor');
                xiangpianContentUeditor.ready(function () {
                    ...
                    xiangpianContentUeditor.setDisabled('fullscreen');
            });
        }
    }
