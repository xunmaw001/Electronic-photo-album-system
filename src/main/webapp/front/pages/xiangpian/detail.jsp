    ...
    <div class="data-detail">
        ...
        <div class="layui-row">
            ...
            <div class="layui-col-md7" style="padding-left: 20px;">
                ...
                <div v-if="detail.RMB" class="detail-item">
                    <span>所在相册编号：</span>
                    <span class="price">
								{{detail.odd}}RMB
							</span>
                </div>
                <div v-if="detail.paishedidian" class="detail-item">
                    <span>拍摄地点：</span>
                    <span class="price">
								{{detail.paishedidian}}
							</span>
                </div>
                <div v-if="detail.paisheren" class="detail-item">
                    <span>相片拍摄人：</span>
                    <span class="desc">
								{{detail.paisheren}}
							</span>
                </div>
                <div v-if="detail.xpsize" class="detail-item">
                    <span>相片大小：</span>
                    <span class="desc">
								{{detail.xpsize}}
							</span>
            ...
            <div class="layui-tab layui-tab-card">
                ...
                <div class="layui-tab-content">
                    ...
                    <div class="layui-tab-item layui-show">
                        <div v-html="detail.xiangpianContent"></div>
                    </div>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function () {
        ...
        http.request(`${vue.detailTable}/info/` + id, 'get', {}, function (res) {
            // 详情信息
            vue.detail = res.data
            vue.title = vue.detail.xpname;
            vue.swiperList = vue.detail.xpimgPhoto
            // 轮播图片
            var swiperItemHtml =
                    '<div>' +
                    '<img class="swiper-item" src="' + vue.detail.xpimgPhoto + '">' +
                    '</div>';
