...
<link rel="stylesheet" href="../../yangshi/css/aos.css" />
<link rel="stylesheet" href="../../yangshi/css/bootstrap.min.css" />
<link rel="stylesheet" href="../../yangshi/css/idangerous.swiper.css" />
<link rel="stylesheet" href="../../yangshi/css/lightbox.css">
<link rel="stylesheet" href="../../yangshi/css/app.css" />
<link rel="stylesheet" href="../../yangshi/css/apmin.css"/>
<style>
  .ng-djn-txt {
    text-align: justify;
...
<body >
  <div id="app">
    <div class="am-add">
      <div class="swiper-container ng-swiper">
        ...
        <div class="swiper-button-prev ng-swiper-ovleft"><img src="../../yangshi/img/snne1.png"/></div>
        <div class="swiper-button-next ng-swiper-ovright"><img src="../../yangshi/img/snne2.png"/></div>
      </div>
    </div>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right"><img src="../../yangshi/img/insie1.png" alt="" /></span>
              <span class="ng-inmod-the-bg ng-inmod-the-bg-right" aos="fade-up-left"><img src="../../yangshi/img/insie2.png" alt="" /></span>
              <span class="ng-inmod-the-cn" aos="fade-down">相片展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
          ...
          <fieldset class="search-container" style="text-align: center;">
            <form class="layui-form">
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">相片名称</label>
                <div class="layui-input-inline">
                  <input type="text" name="xpname" id="xpname" placeholder="相片名称" autocomplete="off" class="layui-input">
                </div>
              </div>   
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../xiangpian/detail.jsp?id='+item.id)">
                      <a href="#" class="ng-prsliik">
                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                          <img :src="item.xpimgPhoto?item.xpimgPhoto.split(',')[0]:''" />
                        </span>
                    ...
                    <div class="ng-prslist-tit" @click="jump('../xiangpian/detail.jsp?id='+item.id)"><span>{{item.xpname}}</span></div>
                  </div>
                </li>
              </ul>
            </div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#xpname').val()) {
          param['xpname'] = jquery('#xpname').val() ? '%' + jquery('#xpname').val() + '%' : '';
        }
          param['xiangcheId'] = http.getParam('id');
        // 获取列表数据
        http.request('xiangpian/list', 'get', param, function(res) {
  ...
  <script src="../../yangshi/js/idangerous.swiper.min.js"></script> 
  <script src="../../yangshi/js/aos.js" type="text/javascript" charset="utf-8"></script> 
  <script src="../../yangshi/js/bootstrap.min.js" type="text/javascript" charset="utf-8"></script> 
  <script src="../../yangshi/js/jquery.superslide.2.1.1.js"></script> 
  <script src="../../yangshi/js/app.js"></script> 
  <script src="../../yangshi/js/jquery-1.7.2.min.js"></script> 
  <script src="../../yangshi/js/lightbox.js"></script> 
