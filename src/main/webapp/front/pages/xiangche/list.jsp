        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">相册展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
            ...
            <form class="layui-form">
              <div class="layui-inline" style="margin-bottom: 10px;">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="xcname" id="xcname" placeholder="相册名称" autocomplete="off" class="layui-input">
                </div>
              </div>   
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../xiangpian/list.jsp?id='+item.id)">
                      <a href="#" class="ng-prsliik">
                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                          <img :src="item.imgPhoto?item.imgPhoto.split(',')[0]:''" />
                        </span>
                    ...
                    <div class="ng-prslist-tit" @click="jump('../xiangpian/list.jsp?id='+item.id)"><span>{{item.xcname}}</span></div>
                  </div>
                </li>
              </ul>
            </div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#xcname').val()) {
          param['xcname'] = jquery('#xcname').val() ? '%' + jquery('#xcname').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('xiangche/list', 'get', param, function(res) {
